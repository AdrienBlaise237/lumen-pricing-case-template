...
export function buildPositioningOutput({ customerSurvey, customerQuotes, competitorPrices, priceSensitivity, surveySegments, priceSensitivitySegments }) {
  ...
  return {
    ...
    supportingEvidence: [
      ...
      'Their average “expensive” threshold is €2.75 and €2.50 respectively, leaving headroom above mass market but below boutique adaptogenic prices.',
    ],
    ...
    cmoImplication: 'Invest in a distinct clean-energy platform: show green-tea caffeine, taste and everyday performance. Do not rely on premium packaging or adaptogen language alone.',
    cfoImplication: 'Avoid a Root & Rise-style boutique price and broad brand spend before repeat is evidenced. Focus investment on the two higher-intent segments and message test results.',
    strategicTradeOff: 'Choose accessible premium rather than maximum luxury signal: LUMEN gives up a €2.59+ boutique position and some short-term margin ceiling to preserve a larger trial pool among high-intent wellness and fitness buyers; it also deliberately does not optimise for budget-student volume.',
    dataProtection: 'Only aggregated survey fields are consumed. Respondent identifiers, names and emails are discarded before any output is created.',
  };
}
